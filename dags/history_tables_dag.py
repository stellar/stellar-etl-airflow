...
from stellar_etl_airflow.build_del_ins_from_gcs_to_bq_task import build_del_ins_from_gcs_to_bq_task
...
del_ins_ops_task = PythonOperator(
    ...
    op_args=[public_project, public_dataset, table_names["operations"], ops_export_task_id, source_object_suffix, True, True, batch_id, batch_date, ops_source_objects],
...
del_ins_trades_task = PythonOperator(
    ...
    python_callable=build_del_ins_from_gcs_to_bq_task,
    op_args=[public_project, public_dataset, table_names["trades"], trades_export_task_id, source_object_suffix, True, True, batch_id, batch_date, trade_source_objects],
    provide_context=True,
    dag=dag,
)
...
del_ins_effects_task = PythonOperator(
    ...
    python_callable=build_del_ins_from_gcs_to_bq_task,
    op_args=[public_project, public_dataset, table_names["effects"], effects_export_task_id, source_object_suffix, True, True, batch_id, batch_date, effects_source_objects],
    provide_context=True,
    dag=dag,
)
...
del_ins_txns_task = PythonOperator(
    ...
    python_callable=build_del_ins_from_gcs_to_bq_task,
    op_args=[public_project, public_dataset, table_names["transactions"], txns_export_task_id, source_object_suffix, True, True, batch_id, batch_date, txns_source_objects],
    provide_context=True,
    dag=dag,
)
...
del_ins_ledgers_task = PythonOperator(
    ...
    python_callable=build_del_ins_from_gcs_to_bq_task,
    op_args=[public_project, public_dataset, table_names["ledgers"], ledgers_export_task_id, source_object_suffix, True, True, batch_id, batch_date, ledger_source_objects],
    provide_context=True,
    dag=dag,
)
...
del_ins_assets_task = PythonOperator(
    ...
    python_callable=build_del_ins_from_gcs_to_bq_task,
    op_args=[public_project, public_dataset, table_names["assets"], assets_export_task_id, source_object_suffix, True, True, batch_id, batch_date, asset_source_objects],
    provide_context=True,
    dag=dag,
)
...
del_ins_cont_events_task = PythonOperator(
    ...
    python_callable=build_del_ins_from_gcs_to_bq_task,
    op_args=[public_project, public_dataset, table_names["contract_events"], cont_evnts_export_task_id, source_object_suffix, True, True, batch_id, batch_date, cont_evnts_source_objects],
    provide_context=True,
    dag=dag,
)
...
(
    time_task >> write_op_stats >> op_export_task >> del_ins_ops_task >> delete_enrich_op_pub_task >> insert_enriched_hist_pub_task
)
...
(
    time_task >> write_tx_stats >> tx_export_task >> del_ins_txns_task >> delete_enrich_op_pub_task
)

(
    time_task >> write_ledger_stats >> ledger_export_task >> del_ins_ledgers_task >> delete_enrich_op_pub_task
)

(
    time_task >> write_asset_stats >> asset_export_task >> del_ins_assets_task >> dedup_assets_pub_task
)

(
    time_task >> write_contract_events_stats >> contract_events_export_task >> del_ins_cont_events_task
)
