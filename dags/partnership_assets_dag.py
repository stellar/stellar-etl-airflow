...
stg_stellar_expert_account_tagging_information_raw = build_dbt_task(dag, 'stg_stellar_expert_account_tagging_information_raw')
...
stg_stellar_expert_account_tagging_information_raw >> int_partnership_assets__account_holders_activity
...
int_partnership_assets__trust_lines_latest >> int_partnership_assets__active_asset_holders

stg_history_operations >> int_partnership_assets__history_operations_filtered_by_partnership_assets
stg_partnership_assets >> int_partnership_assets__history_operations_filtered_by_partnership_assets
stg_partnership_assets >> int_partnership_assets__active_payment_accounts
int_partnership_assets__history_operations_filtered_by_partnership_assets >> int_partnership_assets__active_payment_accounts
...
int_partnership_assets__active_payment_accounts >> partnership_assets__asset_activity_fact
