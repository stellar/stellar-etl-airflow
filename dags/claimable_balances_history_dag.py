...
export_bal_task = build_export_task(dag, 'bounded-core', 'export_ledger_entry_changes', file_names['claimable_balances'], use_testnet=use_testnet, use_gcs=True)
...
'''
send_bal_to_bq_task = build_gcs_to_bq_task(dag, export_bal_task.task_id, 'claimable_balances', '/*-claimable_balances.txt', partition=False)
