...
class CustomGCSToBigQueryOperator(GCSToBigQueryOperator):
    ...
    def pre_execute(self, context, **kwargs):
        ...
        self.max_failed_transforms = self.render_template(self.max_failed_transforms, context)
...
def build_del_ins_from_gcs_to_bq_task(project, dataset, data_type, export_task_id, source_object_suffix, partition, cluster, batch_id ,batch_date, source_objects, **context):
    dag = context['dag']
