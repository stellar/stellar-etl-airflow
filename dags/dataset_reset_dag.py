...
delete_public_enriched_meaningful = build_delete_data_task(
    dag,
    public_project,
    public_dataset,
    "enriched_meaningful_history_operations",
